import{_ as s,c as n,o as a,V as l}from"./chunks/framework.35c8bad0.js";const m=JSON.parse('{"title":"前端开发环境搭建","description":"","frontmatter":{"title":"前端开发环境搭建","date":"2022-07-17T00:00:00.000Z"},"headers":[],"relativePath":"blog/frontend-environment-setup.md","lastUpdated":1713622968000}'),p={name:"blog/frontend-environment-setup.md"},e=l(`<h1 id="前端开发环境搭建" tabindex="-1">前端开发环境搭建 <a class="header-anchor" href="#前端开发环境搭建" aria-label="Permalink to &quot;前端开发环境搭建&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>从零开始搭建前端开发环境</p></div><h2 id="前置条件" tabindex="-1">前置条件 <a class="header-anchor" href="#前置条件" aria-label="Permalink to &quot;前置条件&quot;">​</a></h2><h3 id="node-js" tabindex="-1">Node.js <a class="header-anchor" href="#node-js" aria-label="Permalink to &quot;Node.js&quot;">​</a></h3><p>下载：<a href="https://nodejs.org/en/download/" target="_blank" rel="noreferrer">https://nodejs.org/en/download/</a></p><p>下载路径：Download Node.js v20.12.1 -- node-v20.12.1-x64.msi</p><p>配置</p><div class="language-markdown line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">1、安装路径</span></span>
