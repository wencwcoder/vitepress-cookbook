      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'JavaScript事件循环', link: '/frontend/javascript/240529.md' },
            { text: 'JavaScript_this', link: '/frontend/javascript/241128.md' },
            { text: 'JavaScript_call_apply_bind', link: '/frontend/javascript/241221.md' },
  ...
  '/blog': [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '前端人该如何持续学习', link: '/blog/article/210423.md' },
            { text: '前端职业规划2021年', link: '/blog/article/210524.md' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: '面试题[AI大模型]', link: '/blog/interview/260421.md' },
          ]
        },
        {
          text: '手写系列',
